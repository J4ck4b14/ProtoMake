...
> = {
  ...
  'protomake.light': {
    godot: approximate('PointLight2D/ambient environment'),
  ...
  'protomake.prefab': {
    godot: full('PackedScene metadata'),
...
function assetCapability(
  ...
  if (asset.mime === 'application/x-protomake-tile-set')
    return target === 'godot'
      ? full('TileSet resource generated')
